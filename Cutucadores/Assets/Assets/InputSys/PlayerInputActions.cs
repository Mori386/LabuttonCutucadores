...
public partial class @PlayerInputActions: IInputActionCollection2, IDisposable
{
    ...
    private List<IPlayerGameplayInputMapActions> m_PlayerGameplayInputMapActionsCallbackInterfaces = new List<IPlayerGameplayInputMapActions>();
    ...
    public struct PlayerGameplayInputMapActions
    {
        ...
        public void AddCallbacks(IPlayerGameplayInputMapActions instance)
        {
            if (instance == null || m_Wrapper.m_PlayerGameplayInputMapActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_PlayerGameplayInputMapActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IPlayerGameplayInputMapActions instance)
        {
            @MovementInput.started -= instance.OnMovementInput;
            @MovementInput.performed -= instance.OnMovementInput;
            @MovementInput.canceled -= instance.OnMovementInput;
        ...
        public void RemoveCallbacks(IPlayerGameplayInputMapActions instance)
        {
            if (m_Wrapper.m_PlayerGameplayInputMapActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IPlayerGameplayInputMapActions instance)
        {
            foreach (var item in m_Wrapper.m_PlayerGameplayInputMapActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_PlayerGameplayInputMapActionsCallbackInterfaces.Clear();
